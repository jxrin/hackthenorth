                  ...
                  <form autoComplete="off">
                    ...
                    <FormControl style={{ width: "200px", fontSize: "35px" }}>
                      ...
                      >
                        ...
                        <MenuItem value="A">Do</MenuItem>
                        <MenuItem value="B">Re</MenuItem>
                        <MenuItem value="C">Mi</MenuItem>
                        <MenuItem value="D">Fa</MenuItem>
                        <MenuItem value="E">So</MenuItem>
                        <MenuItem value="F">La</MenuItem>
                        <MenuItem value="G">Ti</MenuItem>
                      </Select>
                    </FormControl>
                  </form>
                  <br />
